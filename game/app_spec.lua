...
describe("game.app", function()
  ...
  describe("game.app.end_turn", function()
    ...
    it("runs the next turn rules", function()
      mock(app.rules.start_turn)
      app.end_turn()
      assert.spy(app.rules.start_turn.execute).was.called()
      assert.spy(app.rules.start_turn.execute).was.called_with(app.rules.start_turn, app.game_state)
    end)
  end)
end)